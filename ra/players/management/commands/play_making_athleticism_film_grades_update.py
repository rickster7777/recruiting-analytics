...
class Command(BaseCommand):
    """
        Use Case: python manage.py play_making_athleticism_film_grades_update
    """
    help = 'Used to updating  Playmaking, Athleticism and Film Grades score.'
    ...
    def handle(self, *args, **options):
        ...
        print("Play Making scores are updated for all players!")
        print("Athleticism and Play Making scores are updated for all players!")
        print("All player has been updated with film grade successfully")
